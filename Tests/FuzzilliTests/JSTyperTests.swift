...
class JSTyperTests: XCTestCase {
    ...
    func testObjectLiterals() {
        ...
        let obj = b.buildObjectLiteral { obj in
            ...
            obj.addGetter(for: "b") { this in
                ...
                XCTAssertEqual(
                    b.type(of: this),
                    .object(ofGroup: "_fuzz_Object0", withProperties: ["a"], withMethods: ["m"]))
            }
            obj.addSetter(for: "c") { this, v in
                XCTAssertEqual(
                    b.type(of: this),
                    .object(
                        ofGroup: "_fuzz_Object0", withProperties: ["a", "b"], withMethods: ["m"]))
            }
        }

        XCTAssertEqual(
            b.type(of: obj),
            .object(ofGroup: "_fuzz_Object0", withProperties: ["a", "b", "c"], withMethods: ["m"]))
        ...
        XCTAssertEqual(
            b.type(of: obj2), .object(ofGroup: "_fuzz_Object1", withProperties: ["prop"]))
    }
        ...
        b.buildObjectLiteral { outer in
            ...
            outer.addMethod("o", with: .parameters(n: 0)) { args in
                ...
                XCTAssertEqual(
                    b.type(of: this),
                    .object(
                        ofGroup: "_fuzz_Object0", withProperties: ["a", "c"], withMethods: ["m"]))
            }
        }
    }
    ...
    func testObjectTypeInference() {
        ...
        XCTAssertEqual(
            b.type(of: obj), .object(ofGroup: "_fuzz_Object0", withProperties: ["bar", "baz"]))
    ...
    func testClasses() {
        ...
        let cls = b.buildClassDefinition { cls in
            ...
            cls.addInstanceMethod("f", with: .parameters(.float)) { params in
                let this = params[0]
                XCTAssertEqual(
                    b.type(of: this), .object(ofGroup: "_fuzz_Class0", withProperties: ["a", "b"]))
            ...
            cls.addInstanceGetter(for: "c") { this in
                XCTAssertEqual(
                    b.type(of: this),
                    .object(
                        ofGroup: "_fuzz_Class0", withProperties: ["a", "b"], withMethods: ["f"]))
            }
            ...
            cls.addInstanceMethod("g", with: .parameters(n: 2)) { params in
                ...
                XCTAssertEqual(
                    b.type(of: this),
                    .object(
                        ofGroup: "_fuzz_Class0", withProperties: ["a", "b", "c"], withMethods: ["f"]
                    ))
    ...
    func testNestedClasses() {
        ...
        let outer = b.buildClassDefinition { cls in
            ...
            cls.addInstanceMethod("m", with: .parameters(n: 0)) { args in
                ...
                XCTAssertEqual(
                    b.type(of: inner),
                    .object(ofGroup: "_fuzz_Constructor1")
                        + .constructor(
        ...
        XCTAssertEqual(
            b.type(of: outer),
            .object(ofGroup: "_fuzz_Constructor0")
                + .constructor(
                    []
                        => .object(
                            ofGroup: "_fuzz_Class0", withProperties: ["a", "c"], withMethods: ["m"])
                ))
    }
    ...
    func testSubClasses() {
        ...
        XCTAssertEqual(
            b.type(of: base2),
            .functionAndConstructor([] => .object(ofGroup: "_fuzz_Object2", withProperties: ["b"])))
        ...
        XCTAssertEqual(
            b.type(of: derived1),
            .object(ofGroup: "_fuzz_Constructor3")
                + .constructor([] => .object(ofGroup: "_fuzz_Class3", withProperties: ["a", "c"])))
        ...
        XCTAssertEqual(
            b.type(of: derived2),
            .object(ofGroup: "_fuzz_Constructor5")
                + .constructor([] => .object(ofGroup: "_fuzz_Class5", withProperties: ["b", "d"])))
        ...
        XCTAssertEqual(
            b.type(of: derived3),
            .object(ofGroup: "_fuzz_Constructor7")
        ...
        XCTAssertEqual(
            b.type(of: derived4),
            .object(ofGroup: "_fuzz_Constructor9")
        ...
        XCTAssertEqual(
            b.type(of: derived5),
            .object(ofGroup: "_fuzz_Constructor11")
                + .constructor(
    ...
    func testSubroutineTypes() {
        ...
        var f = b.buildPlainFunction(with: .parameters(n: 2)) { params in
            XCTAssertEqual(b.type(of: params[0]), .jsAnything)
            XCTAssertEqual(b.type(of: params[1]), .jsAnything)
        }
        XCTAssertEqual(
    ...
    func testIfElseHandling() {
        ...
        b.buildIfElse(
            ...
            elseBody: {
                ...
                XCTAssertEqual(
                    b.type(of: obj),
                    .object(ofGroup: "_fuzz_Object0", withProperties: ["foo", "bar", "bla"]))
    ...
    func testSuperBinding() {
        ...
        XCTAssertEqual(
            b.type(of: superclass),
            .object(ofGroup: "_fuzz_Constructor0") + .constructor([.integer] => superType))
        ...
        let cls = b.buildClassDefinition(withSuperclass: superclass) { cls in
            ...
            cls.addConstructor(with: .parameters([.string])) { params in
                ...
                XCTAssertEqual(
                    b.type(of: this),
                    .object(
                        ofGroup: "_fuzz_Class2", withProperties: ["a", "b"], withMethods: ["f"]))
        ...
        XCTAssertEqual(
            b.type(of: cls),
            .object(ofGroup: "_fuzz_Constructor2")
                + .constructor(
                    [.string]
                        => .object(
            ...
            { i in
                ...
                b.buildForLoop(
                    ...
                    { i in
                        ...
                        return b.loadBool(false)
                    }, { i in XCTAssertEqual(b.type(of: i), .float) }
                ) { i in
                    XCTAssertEqual(b.type(of: i), .float)
                }
                return b.compare(i, with: b.loadInt(10), using: .lessThan)
    ...
    func testSwitchStatementHandling() {
        ...
        b.buildSwitch(on: v2) { swtch in
            ...
            swtch.addDefaultCase {
                ...
                XCTAssertEqual(
                    b.type(of: v1),
                    .object(ofGroup: "_fuzz_Object0", withProperties: ["foo", "bar", "qux"]))
    ...
    func testWasmStructTypeDefinition() {
        ...
        XCTAssert(b.type(of: structType).Is(.wasmTypeDef()))
        let desc =
            b.type(of: structType).wasmTypeDefinition!.description! as! WasmStructTypeDescription
        XCTAssertEqual(desc.fields.count, 2)
        XCTAssertEqual(desc.fields[0].type, .wasmi32)
        XCTAssertEqual(desc.fields[1].type, .wasmi64)
    }
    ...
    func testDynamicObjectGroupTypingOfClassesWithGettersAndSetters() {
        ...
        XCTAssertEqual(
            b.type(of: classDef),
            .object(ofGroup: "_fuzz_Constructor0") + .constructor([.integer] => instanceType))
    ...
    func testDynamicObjectGroupTypingOfLiterals() {
        ...
        XCTAssertEqual(
            b.type(of: object),
            .object(ofGroup: "_fuzz_Object0", withProperties: ["bla"], withMethods: ["foo"]))
    ...
    func testBuiltinPrototypes() {
        ...
        XCTAssertEqual(
            b.type(of: indexOf),
            .unboundFunction([.jsAnything, .opt(.integer)] => .integer, receiver: .jsArray))
        ...
        XCTAssertEqual(
            b.type(of: then), .unboundFunction([.function()] => .jsPromise, receiver: .jsPromise))
        ...
        XCTAssertEqual(
            b.type(of: resize), .unboundFunction([.integer] => .undefined, receiver: .jsArrayBuffer)
        )
        ...
        XCTAssert(
            b.type(of: sharedArrayBufferProto).Is(.object(ofGroup: "SharedArrayBuffer.prototype")))
    ...
    func testWebAssemblyBuiltins() {
        ...
        XCTAssert(
            b.type(of: wasmModuleConstructor).Is(.object(ofGroup: "WebAssemblyModuleConstructor")))
        ...
        XCTAssert(
            b.type(of: wasmGlobalConstructor).Is(.object(ofGroup: "WebAssemblyGlobalConstructor")))
        ...
        XCTAssert(
            b.type(of: tableGrow).Is(
                .unboundFunction(
                    [.number, .opt(.jsAnything)] => .number, receiver: .object(ofGroup: "WasmTable")
                )))
