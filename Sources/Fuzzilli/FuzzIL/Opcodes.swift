...
enum Opcode {
    ...
    case classAddProperty(ClassAddProperty)
    case classAddElement(ClassAddElement)
    case classAddComputedProperty(ClassAddComputedProperty)
    case beginClassMethod(BeginClassMethod)
    case endClassMethod(EndClassMethod)
    case beginClassComputedMethod(BeginClassComputedMethod)
    case endClassComputedMethod(EndClassComputedMethod)
    case beginClassGetter(BeginClassGetter)
    case endClassGetter(EndClassGetter)
    case beginClassSetter(BeginClassSetter)
    case endClassSetter(EndClassSetter)
    case beginClassStaticInitializer(BeginClassStaticInitializer)
    case endClassStaticInitializer(EndClassStaticInitializer)
    case classAddPrivateProperty(ClassAddPrivateProperty)
    case beginClassPrivateMethod(BeginClassPrivateMethod)
    case endClassPrivateMethod(EndClassPrivateMethod)
