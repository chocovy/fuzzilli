...
private struct SandboxFuzzingPostProcessor: FuzzingPostProcessor {
    func process(_ program: Program, for fuzzer: Fuzzer) throws -> Program {
        ...
        func corruptSomething() {
            ...
            guard
                let target = b.findVariable(satisfying: { v in
            ...
            for _ in 0..<numCorruptions {
                ...
                case 0.80..<0.90:
                    ...
                    command =
                        "corruptWithWorker(%@, \(pathArray), \(offsetSeed), \(size), \(subFieldOffset), \(bitPosition))"
                case 0.90..<1.0:
                ...
                default:
                    ...
                    let randomMagnitudeValue =
                        lower == upper ? lower : UInt64.random(in: lower..<upper)
